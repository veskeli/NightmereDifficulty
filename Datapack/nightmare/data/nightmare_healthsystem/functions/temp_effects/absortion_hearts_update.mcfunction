...
execute if score @s Nightmare_AbsortionHearts matches 3 run effect give @s absorption infinite 1 true
execute if score @s Nightmare_AbsortionHearts matches 4 run effect give @s absorption infinite 1 true
execute if score @s Nightmare_AbsortionHearts matches 5 run effect give @s absorption infinite 2 true
execute if score @s Nightmare_AbsortionHearts matches 6 run effect give @s absorption infinite 2 true
execute if score @s Nightmare_AbsortionHearts matches 7 run effect give @s absorption infinite 3 true
execute if score @s Nightmare_AbsortionHearts matches 8 run effect give @s absorption infinite 3 true
execute if score @s Nightmare_AbsortionHearts matches 9 run effect give @s absorption infinite 4 true
execute if score @s Nightmare_AbsortionHearts matches 10 run effect give @s absorption infinite 4 true
execute if score @s Nightmare_AbsortionHearts matches 11 run effect give @s absorption infinite 5 true
execute if score @s Nightmare_AbsortionHearts matches 12 run effect give @s absorption infinite 5 true
execute if score @s Nightmare_AbsortionHearts matches 13 run effect give @s absorption infinite 6 true
execute if score @s Nightmare_AbsortionHearts matches 14 run effect give @s absorption infinite 6 true
execute if score @s Nightmare_AbsortionHearts matches 15 run effect give @s absorption infinite 7 true
execute if score @s Nightmare_AbsortionHearts matches 16 run effect give @s absorption infinite 7 true
execute if score @s Nightmare_AbsortionHearts matches 17 run effect give @s absorption infinite 8 true
