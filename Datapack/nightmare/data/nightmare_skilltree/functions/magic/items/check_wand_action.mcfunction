...
# Check main hand
execute if entity @s[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",tag:{CustomTags:["slowness1"]}}}] at @s run function nightmare_skilltree:magic/items/wands/slowness1/start
execute if entity @s[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",tag:{CustomTags:["slowness1"]}}}] at @s run return 1
# Check off hand
execute if entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:-106b,tag:{CustomTags:["slowness1"]}}]}] at @s run function nightmare_skilltree:magic/items/wands/slowness1/start
...
# Check main hand
execute if entity @s[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",tag:{CustomTags:["haste1"]}}}] at @s run function nightmare_skilltree:magic/items/wands/haste1/start
execute if entity @s[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",tag:{CustomTags:["haste1"]}}}] at @s run return 1
# Check off hand
execute if entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:-106b,tag:{CustomTags:["haste1"]}}]}] at @s run function nightmare_skilltree:magic/items/wands/haste1/start
